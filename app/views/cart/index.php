    ...
    <form action="<?= ROOT ?>cart/update" method="POST">
        <table class="table table-stripped" width="100%">
            ...
            <tr>
                ...
                <td class="text-right"><input type="number" name="c<?= $key ?>" value="<?= number_format($value->quantity, 0) ?>" min="1" max="99" class="text-right">
        ...
        <table width="100%" class="text-right">
            ...
            <tr>
                <td><a href="<?= ROOT ?>shop" class="btn btn-outline-info" role="button">Seguir comprando</a></td>
                <td><input type="submit" class="btn btn-outline-info" role="button" value="Recalcular"></td>
                <td><a href="<?= ROOT ?>cart/checkout" class="btn btn-outline-success" role="button">Pagar</a></td>
            </tr>
        </table>
    </form>
